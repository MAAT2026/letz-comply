...
export default function StepInvestorProfile({ data, onChange, onNext, onBack }) {
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            type="number"
            value={data.minCommitment || ""}
            onChange={e => set("minCommitment", Number(e.target.value))}
          />
        </div>
        <div className="space-y-1.5">
      ...
      <div className="flex gap-3">
        ...
        <Button onClick={() => onNext(data)} className="flex-1">Continue to Terms →</Button>
      </div>
    </div>
  );
}